# APPUiO - OpenShift 3 Techlab Documentation

This Techlab is based on OpenShift 3.5.

**Tipp** The Techlabs to previous Versionens can be found in their Branches:
...
1. [Quicktour through OpenShift 3](labs/01_quicktour.md)
2. [Install OpenShift CLI](labs/02_cli.md)
3. [First steps through the Lab Plattform](labs/03_first_steps.md)
4. [Deploy a Docker Image](labs/04_deploy_dockerimage.md)
5. [Create a Route](labs/05_create_route.md)
6. [Scaling](labs/06_scale.md)
7. [Troubleshooting, what is in the Pod?](labs/07_troubleshooting_ops.md)
8. [Deploy and Attach a Database](labs/08_database.md)
9. [Directly integrate code changes via webhook](labs/09_dockerbuild_webhook.md)
10. [Attach persistent storage and use it for the Database](labs/10_persistent_storage.md)
